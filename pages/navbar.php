                ...
                <div class="flex items-center">
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="login.php" class="bg-white text-blue-700 px-4 py-2 rounded-md text-sm font-medium shadow-sm hover:bg-gray-100 transition duration-150 ease-in-out">Login</a>
                        </div>
                    </div>
                    <!-- Mobile menu button -->
